...
Local evidence is strong: 65 automated tests, executable PostgreSQL migration/seed, all strict TypeScript/build/format/lint gates, a bundled API smoke test, Expo Doctor 20/20, clean peer dependencies, 11-route web export, live source-backed lookup, and rendered visual review at three mobile viewports.
