...
| Mandatory local tests | **Pass on 2026-09-10** | Format, lint, typecheck, 164 application/17 policy tests (181 total), API/package builds and 12-route web export pass with nested pnpm 11.16.0. No timeout was relaxed |
