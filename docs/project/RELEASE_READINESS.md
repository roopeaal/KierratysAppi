...
| Security/privacy | Implemented baseline | Threat model, POST boundary, validation, response limits, CORS allowlist, RLS, Gitleaks/dependency gates; CodeQL prepared but externally feature-gated |
