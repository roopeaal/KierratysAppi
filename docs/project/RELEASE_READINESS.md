...
| --- | --- | --- |
| Core source flow | Pass locally | Manual/live API→OFF and automated state/domain/provider/API evidence; September 7 fresh-client Home/manual/known-product physical-iPhone smoke passes with uncertainty and Rinki provenance |
...
| Android/iOS builds | Partial/blocked | Fresh iOS Debug compile/sign/11-framework verification/install/launcher passes on 2026-09-04; phone-to-Metro TCP and the current Home/manual/known-product development smoke pass on September 7. Android and iOS archive/TestFlight/release builds remain absent |
