...
Verified: 2026-08-10. Secret presence was checked without intentionally reading values.
...
| Accessibility audit | Yes | Accessibility skills, tests | Platform screen readers/device review | High | Local UI/device | Use automated checks; device review blocked |
...
| End-to-end testing | Yes | Browser tooling; no device runtime | Maestro/Detox candidate | High | App/device | Research; physical run blocked |
